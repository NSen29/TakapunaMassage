        ...
        return (  
            <div className='page-background'>
                <div style={{display: 'flex',  justifyContent:'center', alignItems:'center'}}>
                    <Carousel showArrows={true} dynamicHeight={false} infiniteLoop={true} autoPlay={true} swipeable={true} emulateTouch={true} showStatus={false} width={'1000px'}>
                        <div>
                            <div className='head-text'>
                                ...
                                <div className='text-on-image'>
                                    <h1>Treat yourself to a massage, free your mind, calm your body and soul</h1>
                                    <Button style={{borderRadius: 35, backgroundColor: "#FFFFFF", fontWeight: 'bold'}} color="black" component={Link} to="/booking">Book now</Button>
                                    <p></p>
                                </div>
                            </div>                  
                        </div>     
                ...
                <div style={{display: 'flex',  justifyContent:'center', alignItems:'center'}} className='picture-text'>
                    <img src={storefront} alt="store front" width='600px'/>
                    <h2 style={{margin:'5%'}}>Takapuna Therapeutic Massage is a Professional Traditional Massage shop in Takapuna North Shore. 
                            ...
                            Treat yourself to a massage -let yourself go, free your mind and calm your body and soul.</h2>
                    </div>
            </div>
        )
    }
